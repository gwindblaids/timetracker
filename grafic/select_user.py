...
class Ui_selectUserWindow(object):
    def setupUi(self, selectUserWindow):
        selectUserWindow.setObjectName("selectUserWindow")
        selectUserWindow.resize(403, 298)
        ...
        selectUserWindow.setMinimumSize(QtCore.QSize(403, 298))
        selectUserWindow.setMaximumSize(QtCore.QSize(403, 298))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../images/icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        selectUserWindow.setWindowIcon(icon)
        selectUserWindow.setStyleSheet("background-color: #414053;")
        selectUserWindow.setAnimated(True)
        self.centralwidget = QtWidgets.QWidget(selectUserWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.verticalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(60, 30, 281, 231))
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("../images/users_photo/addNewUser.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("../images/users_photo/default.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        selectUserWindow.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(selectUserWindow)
        self.statusbar.setObjectName("statusbar")
        selectUserWindow.setStatusBar(self.statusbar)

        self.retranslateUi(selectUserWindow)
        QtCore.QMetaObject.connectSlotsByName(selectUserWindow)

    def retranslateUi(self, selectUserWindow):
        _translate = QtCore.QCoreApplication.translate
        selectUserWindow.setWindowTitle(_translate("selectUserWindow", "TimeTracker"))
