...
class Ui_NewUserWindow(object):
    def setupUi(self, NewUserWindow):
        ...
        NewUserWindow.resize(507, 447)
        NewUserWindow.setMinimumSize(QtCore.QSize(507, 447))
        NewUserWindow.setMaximumSize(QtCore.QSize(507, 447))
        icon = QtGui.QIcon()
        ...
        self.verticalWidget.setGeometry(QtCore.QRect(50, 20, 411, 391))
        ...
        self.name_text = QtWidgets.QTextEdit(self.verticalWidget)
        ...
        self.name_text.setMaximumSize(QtCore.QSize(16777215, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.name_text.setFont(font)
        self.name_text.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.name_text.setObjectName("name_text")
        self.horizontalLayout_3.addWidget(self.name_text)
        ...
        self.last_name_text = QtWidgets.QTextEdit(self.verticalWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.last_name_text.sizePolicy().hasHeightForWidth())
        self.last_name_text.setSizePolicy(sizePolicy)
        self.last_name_text.setMaximumSize(QtCore.QSize(16777215, 35))
        font = QtGui.QFont()
        font.setPointSize(12)
        self.last_name_text.setFont(font)
        self.last_name_text.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.last_name_text.setObjectName("last_name_text")
        self.horizontalLayout.addWidget(self.last_name_text)
